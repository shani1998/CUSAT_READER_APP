            ...
            public void onClick(View view)
            {
                ...
                switch (s)
                {
                    case "IT":
                        ...
                        break;
                    case "CSE":
                        startActivity(new Intent(getApplicationContext(), S4cseR.class));
                        break;
            ...
            public void onClick(View view)
            {
                switch (s)
                {
                    case "IT":
                        ...
                        break;
                    case "CSE":
                        startActivity(new Intent(getApplicationContext(), S5cseR.class));
                        break;
            ...
            public void onClick(View view)
            {
                ...
                switch (s) {
                    case "IT":
                        ...
                        break;
                    case "CSE":
                        startActivity(new Intent(getApplicationContext(), S6cseR.class));
                        break;
            ...
            public void onClick(View view)
            {
                ...
                switch (s)
                {
                    case "IT":
                        ...
                        break;
                    case "CSE":
                        startActivity(new Intent(getApplicationContext(), S7cseR.class));
                        break;
            ...
            public void onClick(View view)
            {
                ...
                switch (s)
                {
                    case "IT":
                        ...
                        break;
                    case "CSE":
                        startActivity(new Intent(getApplicationContext(), S8cseR.class));
                        break;
